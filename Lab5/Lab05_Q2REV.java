...
public class Lab05_Q2REV
{
    ...
    public static boolean p1Route2Available = true;
    public static boolean p1Route3Available = true;
    public static boolean p2Route2Available = true;
    public static boolean p2Route3Available = true;
    public static boolean p3Route2Available = true;
    public static boolean p3Route3Available = true;
    ...
    public static void main(String[] args)
    {
        ...
        while (isOn)
        {
            ...
            if (colorString.equals(""))
                routeAvaiable = false;
            else if (colorString.length() == 2 && player1Route2.equals("") && colorString.equals("RR")
                    || colorString.length() == 3 && player1Route3.equals("") && colorString.equals("GGG")
            ...
            else
            {
                ...
                if (colorStringLenght == 2 && player1Route2.equals("") && colorString.equals("RR"))
                {
                    player1Route2 = colorString;
                    p1Route2Available = false;
                } else if (colorStringLenght == 3 && player1Route3.equals("") && colorString.equals("GGG"))
                {
                    player1Route3 = colorString;
                    p1Route3Available = false;
            ...
            if (colorString.equals(""))
                routeAvaiable = false;
            else if (colorString.length() == 2 && player2Route2.equals("") && colorString.equals("RR")
                    || colorString.length() == 3 && player2Route3.equals("") && colorString.equals("GGG")
            ...
            else
            {
                // Add the color to the correct route
                colorStringLenght = colorString.length();
                if (colorStringLenght == 2 && player2Route2.equals("") && colorString.equals("RR"))
                {
                    player2Route2 = colorString;
                    p2Route2Available = false;
                } else if (colorStringLenght == 3 && player2Route3.equals("") && colorString.equals("GGG"))
                {
                    player2Route3 = colorString;
                    p2Route3Available = false;
            ...
            if (colorString.equals(""))
                routeAvaiable = false;
            else if (colorString.length() == 2 && player3Route2.equals("") && colorString.equals("RR")
                    || colorString.length() == 3 && player3Route3.equals("") && colorString.equals("GGG")
            ...
            else
            {
                // Add the color to the correct route
                colorStringLenght = colorString.length();
                if (colorStringLenght == 2 && player3Route2.equals("") && colorString.equals("RR"))
                {
                    player3Route2 = colorString;
                    p3Route2Available = false;
                } else if (colorStringLenght == 3 && player3Route3.equals("") && colorString.equals("GGG"))
                {
                    player3Route3 = colorString;
                    p3Route3Available = false;
        ...
        // System.out.printf("TOTAL = %s", player1RemainingCardCount +
        // player1RoutePoints + player2RemainingCardCount
        // + player2RoutePoints + player3RemainingCardCount + player3RoutePoints +
        // deck.length());
    ...
    {
        boolean route2Available = true;
        boolean route3Available = true;
        ...
        {
            route2Available = p1Route2Available;
            route3Available = p1Route3Available;
        }
        if (player.equals(player2))
        {
            route2Available = p2Route2Available;
            route3Available = p2Route3Available;
        }
        if (player.equals(player3))
        {
            route2Available = p3Route2Available;
            route3Available = p3Route3Available;
        }

        if (greenCount >= 3 && route3Available)
        {
            for (int i = 0; i < 3; i++)
                result += "G";
        } else if (redCount >= 2 & route2Available)
        {
            for (int i = 0; i < 2; i++)
                result += "R";
        } else
