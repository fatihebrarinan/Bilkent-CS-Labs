...
public class Cipher
{
    ...
    // for the encrypted ones
    // encryption involves mapping from original to cipher, for each letter we
    // locate the character in the
    // original string and replace it with the cipher alphabet letter at the same
    // position
    ...
    // should not replace symbols or upper case letters, return input char in those
    // cases
