...
public class SkyBattleGameREV
{
    ...
    public final static char DARK_KNIGHT_SYMBOL = '2';// ♘
    public final static char KNIGHT_SYMBOL = '1';// ♞
    public final static char HEALTH_ORB_SYMBOL = '*';

    // Game Members
    public static int score = 0;
    private static BattleManagerREV battleManager;
    ...
    {
        battleManager = new BattleManagerREV();
        scanner = new Scanner(System.in);
    }

    /*
     * Runs the main game loop, which continues until the Knight’s health is
     * depleted. It repeatedly renders the game and handles user input.
     */
     ...
     * information (Knight's stats and points).
     */
    private static void renderGame()
    {
        KnightREV knight = battleManager.getKnight();
        ArrayList<BattleColumnREV> columns = battleManager.getColumns();
     ...
     * the grid.
     */
    private static void displayBattleground(KnightREV knight, ArrayList<BattleColumnREV> columns)
    {
        for (int i = 0; i < ROWS; i++)
        {
            ...
            for (int j = 0; j < COLS; j++)
            {
                ...
                BattleColumnREV column = columns.get(j);
     ...
     */
    private static void displayGameInformation(KnightREV knight)
    {
     ...
     * directs it to battleManager to execute.
     */
     ...
     * in the grid.
     */
    private static boolean isKnightPositionedAt(KnightREV knight, int x, int y)
    {
